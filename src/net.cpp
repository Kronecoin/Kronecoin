...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "KroneCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"kronecoin.org","35.176.102.26"},
    {"kronecoin.org","35.176.12.96"},
    {"kronecoin.org","35.176.130.60"},
    {"kronecoin.org","35.176.166.149"},
	{"kronecoin.org","seed.kronecoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. KroneCoin is probably already running."), addrBind.ToString().c_str());
        else
